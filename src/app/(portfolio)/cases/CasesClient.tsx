    ...
    <>
      ...
      <main className="px-6 md:px-12 py-24 max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">All Cases</h1>
          <p className="text-lg text-[var(--text-muted)] max-w-2xl">
            {projects.length} projects across product design, frontend development, fintech, and
            more — spanning 15+ years of work.
          </p>
        </motion.div>
              ...
              <Link href={`/projects/${project.slug}`}>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-muted)] mt-0.5">{project.location}</p>
                  </div>
                  <svg
